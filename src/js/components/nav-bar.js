...
const Nav = React.createClass({
        ...
        return{
            navList:[
                ...
                {key:"产品库存",type:"appstore",children:[
                    ...
                    {key:"库存管理",value:6,path:"/stock"},
                    {key:"出入库明细",value:7,path:"/output"}]},
                {key:"生产管理",type:"solution",children:[
                    {key:"生产订单",value:8,path:"/production/order"},
                    {key:"订单统计",value:9,path:"/statistic"}]},
                {
                    key:"结算管理",type:"appstore",children:[
                        {key:"送货单管理",value:10,path:"/deliverynote"}
                    ]
    ...
    handleClick(e){
        let {navList,downList,upList,storeList} = this.state;
    ...
    render(){
        let _this = this;
        let {navList,downList,upList,storeList} = _this.state;
        let type =  localStorage.type;
        let list = [];
        switch (type*1){
            case 1:
        ...
        return(
            <div className = "nav-div no-print">
